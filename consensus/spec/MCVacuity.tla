...
\* Non-vacuity probe: expected to be VIOLATED, proving an honest stable
\* quorum is reachable and the liveness properties are not vacuous.
NeverHonestQuorum == ~HonestQuorumExists
